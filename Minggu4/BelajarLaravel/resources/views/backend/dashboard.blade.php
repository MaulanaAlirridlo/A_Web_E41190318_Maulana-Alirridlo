                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table bootstrap-datatable countries">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="{{ asset('backend/img/Germany.png') }}"
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('backend/img/India.png') }}"
                                                style="height:18px; margin-top:-2px;"></td>
                                        <td>India</td>
                                        <td>3652</td>
                                        <td>2563</td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('backend/img/Spain.png') }}"
                                                style="height:18px; margin-top:-2px;"></td>
                                        <td>Spain</td>
                                        <td>562</td>
                                        <td>452</td>
                                ...
                                <ul class="chats">
                                    ...
                                    <li class="by-me">
                                        ...
                                        <div class="chat-content">
                                            ...
                                            <div class="chat-meta">John Smith <span class="pull-right">3 hours ago</span>
                                            </div>
                                    ...
                                    <li class="by-me">
                                        ...
                                        <div class="chat-content">
                                            <div class="chat-meta">John Smith <span class="pull-right">4 hours ago</span>
                                            </div>
                                    ...
                                    <td>
                                        <span class="profile-ava">
                                            <img alt="" class="simple"
                                                src="{{ asset('backend/img/avatar1_small.jpg') }}">
                                        </span>
                                    </td>
                                </tr>
                                <tr>
